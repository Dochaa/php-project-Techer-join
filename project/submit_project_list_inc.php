...
<?php
 	...
 	$q="SELECT * FROM submit_project  where id_submit_project not in('".$_GET['sbt_id']."') and sp_status   in('1','2') and register_project_id='".$id_register_project."' order by id_submit_project asc";
...
<a  style="text-decoration:none;" href="register_project_detail.php?id=<?php echo $id_register_project; ?>&link=submit_project_detail&&sbt_stt=3&sbt_id=<?php echo $id_submit_project; ?>#<?php echo $id_submit_project; ?>"> <span class="w3-tag w3-blue-grey"> รายละเอียด </span></a> 
<?php } ?>
