...
<div class="row">
  ...
  <section>
    <h1> <strong><i class="fa fa-th-list" aria-hidden="true"></i> ข้อมูลนัดสอบ</strong></h1>
<article>
...
<div  class="title-center">
  <h3>รายการนัดสอบโครงงานนักศึกษา</h3> 
</div>
</div>
...
$q="SELECT * FROM schedule  where(year LIKE '%".$keyword."%' or name LIKE '%".$keyword."%')  order by id_schedule desc";
}else{


$q="SELECT * FROM schedule  where sd_status='1'  order by id_schedule desc";
...
?>
  <table width="100%" class="w3-table w3-bordered w3-table-all" >
    <tr>
      ...
      <th width="9%"><div align="left">ปีการศึกษา</div>      </th>
      <th width="27%">ชื่อโครงงาน</th>
      <th width="16%">อาจารย์ที่ปรึกษา</th>
      <th width="14%">วันที่นัดสอบ</th>
      <th width="15%">สถานะ</th>
      <th width="13%" class="w3-hide-small w3-hide-medium"><div align="center">  ข้อมูล </div></th>
      </tr>
<?php 
				// for($i=1;$i<=50;$i++){ 
    ...
    <tr>
      ...
      <td><?php echo $sd_year; ?>  </td>
      <td><?php echo $sd_register_project; ?></td>
      <td align="center"><?php echo $sd_user_name; ?></td>
      <td align="center"><?php echo $sd_dates1; ?></td>
      <td align="center"><?php echo $txt_sd_status; ?></td>
      <td class="w3-hide-small w3-hide-medium">
	  <div align="center"><a  style="text-decoration:none;" href="register_project_detail.php?id=<?php echo $register_project_id; ?>&sd_id=<?php echo $id_schedule; ?>"> <span class="w3-tag w3-blue-grey"> ข้อมูล </span></a> </div></td>
      </tr>
<?php } ?> 
  </table>
<?php // if($total > $e_page){ ?>
