...
$q="SELECT * FROM login, user where(user LIKE '%".$keyword."%' or user_name LIKE '%".$keyword."%')  and type='student' and id_login=id_user order by id_login asc";
}else{
$q="SELECT * FROM login, user where type='student' and id_login=id_user order by id_login asc";
}
...
?>
  <table width="100%" class="w3-table w3-bordered w3-table-all" >
    <tr>
      <th width="8%" class="w3-hide-small w3-hide-medium"  style="text-align:center;">ลำดับ</th>
      <th width="12%" class="w3-hide-small w3-hide-medium"  style="text-align:center;">รหัสนักศึกษา</th>
      <th width="21%"><div align="left">ชื่อ-นามสกุล</div>      </th>
...
<?php 
    ...
    <tr>
	  ...
	  <div align="center"><a  style="text-decoration:none;" href="user_student_detail.php?id=<?php echo $id_login; ?>"><span class="w3-tag w3-blue-grey">ข้อมูล</span></a></div></td>
      <td class="w3-hide-small w3-hide-medium">
	  <div align="center"><a  style="text-decoration:none;" href="login_tb.php?del_id=<?php echo $id_login; ?>"  onclick=" return confirm('ลบข้อมูลผู้ใช้ <?php echo $user_name; ?> ออกจากระบบ')"><span class="w3-tag w3-blue-grey"> ลบ</span></a></div>	  </td>
    </tr>
<?php } ?> 
  </table>
<?php // if($total > $e_page){ ?>
