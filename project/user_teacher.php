...
$q="SELECT * FROM login, user where(user_code LIKE '%".$keyword."%' or user_name LIKE '%".$keyword."%')  and type='teacher' and id_login=id_user order by id_login asc";
}else{
$q="SELECT * FROM login, user where type='teacher' and id_login=id_user order by id_login asc";
}
...
?>
  <table width="100%" class="w3-table w3-bordered w3-table-all" >
    <tr>
      <th width="7%" class="w3-hide-small w3-hide-medium"  style="text-align:center;">ลำดับ</th>
      <th width="14%" class="w3-hide-small w3-hide-medium"  style="text-align:center;">รหัสอาจารย์</th>
      <th width="20%"><div align="left">ชื่อ-นามสกุล</div>      </th>
      <th width="16%">เบอร์โทร</th>
      <th width="25%">อีเมล์</th>
      <th width="9%" class="w3-hide-small w3-hide-medium"><div align="center">  ข้อมูล </div></th>
      <th width="9%" class="w3-hide-small w3-hide-medium"><div align="center"> ลบ</div></th>
    </tr>
<?php 
				// for($i=1;$i<=50;$i++){ 
    ...
    <tr>
	  ...
	  <div align="center"><a  style="text-decoration:none;" href="user_teacher_detail.php?id=<?php echo $id_login; ?>"> <span class="w3-tag w3-blue-grey">ข้อมูล</span></a></div></td>
      <td class="w3-hide-small w3-hide-medium">
	  <div align="center">
	<span class="w3-tag w3-blue-grey"><a  style="text-decoration:none;" href="login_tb.php?del_id=<?php echo $id_login; ?>"  onclick=" return confirm('ลบข้อมูลผู้ใช้ <?php echo $user_name; ?> ออกจากระบบ')"><span class="w3-tag w3-blue-grey"> ลบ </span></a>    </div>	  </td>
    </tr>
<?php } ?> 
  </table>
<?php // if($total > $e_page){ ?>
    ...
    <div class="w3-modal-content w3-card-4">
     ...
     <form  class="w3-container frm_login " method="post" action="login_tb.php" enctype="multipart/form-data" name="frm1"  id="frm1">
	  ...
	  <div class="w3-container">
		...
		<input name="user_address" type="text" class="w3-input w3-border w3-sand" id="user_address"  maxlength="15" required>
		</p>
		<p>      
		<label class="w3-text-brown"><b>เบอร์โทร</b></label>
		<input name="user_tel" type="text" class="w3-input w3-border w3-sand" id="user_tel" maxlength="15" required>
		</p>
