...
<div  class="title-center">
 ...
 <table width="100%" class="w3-table w3-bordered w3-table-all" >
    ...
    <tr>
      <th width="19%" align="right" valign="middle">รหัส:</th>
    ...
    <div class="w3-modal-content w3-card-4">
     ...
     <form  class="w3-container frm_login " method="post" action="login_tb.php" enctype="multipart/form-data" name="frm1"  id="frm1">
	  ...
	  <div class="w3-container">
		...
		<p>      
		<label class="w3-text-brown"><b>รหัสผู้ใช้ระบบ</b></label>
		<input class="w3-input w3-border w3-sand" id="user_name" type="text" name="user_code" value="<?php echo $user_code; ?>" required>
		</p>
		<p>      
		...
		<script src="ckediter/ckeditor.js"></script>
	  		<!-- Sample 1  -->
		<textarea name="user_note" cols="200" rows="10" class="frm500" id="profile" >
			<?php echo $user_note; ?>
		</textarea>
